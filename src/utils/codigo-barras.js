const getBoletoArrecadacaoCodigoBarras = (codigo) => {
...
const getBoletoBancarioCodigoBarras = (codigo) => {
  let codigoBarras = ''
...
const codigoDeBarras = (codigo) => {
  if (codigo.length === 47) return getBoletoBancarioCodigoBarras(codigo)
  if (codigo.length === 48) return getBoletoArrecadacaoCodigoBarras(codigo)

  return false
}

module.exports = codigoDeBarras